...
class Config extends Manage
{
    ...
    public function other(): array
    {
        $keys = [
            ...
            "cloud_download_apk",
            "cloud_download_1",
            "cloud_download_apk_1",
            "simulator_download",
            "simulator_download_1",
            "simulator_download_apk",
            "filtering_tg_min",
            "filtering_ws_min",
            "filtering_tg", "filtering_ws", "simulator_matter", "cloud_matter", "recharge_rate", "recharge_min", "commodity_recommend", "commodity_name", "recharge_max", "cname", "default_category", "callback_domain", "recharge_welfare_config", "recharge_welfare", "promote_rebate_v1", "promote_rebate_v2", "promote_rebate_v3", "substation_display", "domain", "service_url", "service_qq", "cash_type_alipay", "cash_type_wechat", "cash_type_balance", "cash_cost", "cash_min"]; //全部字段
        $inits = [
            "cloud_download",
            "cloud_download_apk",
            "cloud_download_1",
            ...
            "filtering_tg_min",
            "filtering_ws_min",
            "filtering_tg", "filtering_ws", "simulator_matter", "cloud_matter", "recharge_rate", "recharge_min", "commodity_recommend", "recharge_max", "recharge_welfare", "substation_display", "cash_type_alipay", "cash_type_wechat", "cash_type_balance", "cash_cost", "cash_min", "default_category"]; //需要初始化的字段
