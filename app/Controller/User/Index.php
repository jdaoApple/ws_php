...
class Index extends User
{
    ...
    public function index(): string
    {
        ...
        $trade = \App\Model\Order::query()->where("user_id", $this->getUser()->id)->whereDate('create_time',date('Y-m-d'))->where("status", 1)->sum("amount");

        return $this->theme("首页", "INDEX", "Index/Index.html", [
            'user' => $this->getUser(),
            'from' => $from,
            "categoryId" => $map['a'],
            "commodityId" => $map['b'],
